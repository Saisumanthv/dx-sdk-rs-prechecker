...
use dharitri_sc::api::{const_handles, use_raw_handle, HandleConstraints, RawHandle};
...
pub struct TxStaticVars {
    ...
    pub(crate) call_value_moax_handle: RawHandle,
    pub(crate) call_value_multi_dct_handle: RawHandle,
}
