...
fn struct_with_numbers_static() {
    assert_eq!(
        <ManagedStructWithToken<DebugApi> as dharitri_sc::types::ManagedVecItem>::PAYLOAD_SIZE,
        28
    );
    assert!(
        !<ManagedStructWithToken<DebugApi> as dharitri_sc::types::ManagedVecItem>::SKIPS_RESERIALIZATION
    );
}
...
fn struct_to_bytes_writer() {
    ...
    <ManagedStructWithToken<DebugApi> as dharitri_sc::types::ManagedVecItem>::to_byte_writer(
        &s,
        |bytes| {
            arr[0
                ..<ManagedStructWithToken<DebugApi> as dharitri_sc::types::ManagedVecItem>::PAYLOAD_SIZE]
...
fn struct_from_bytes_reader() {
    ...
    let struct_from_bytes =
        <ManagedStructWithToken<DebugApi> as dharitri_sc::types::ManagedVecItem>::from_byte_reader(
            |bytes| {
