...
fn forw_raw_async_accept_moax_rs() {
    dharitri_sc_scenario::run_rs("scenarios/forw_raw_async_accept_moax.scen.json", world());
}

#[test]
fn forw_raw_async_accept_dct_rs() {
    dharitri_sc_scenario::run_rs("scenarios/forw_raw_async_accept_dct.scen.json", world());
}
...
fn forw_raw_direct_moax_rs() {
    dharitri_sc_scenario::run_rs("scenarios/forw_raw_direct_moax.scen.json", world());
}

#[test]
fn forw_raw_direct_dct_rs() {
    dharitri_sc_scenario::run_rs("scenarios/forw_raw_direct_dct.scen.json", world());
}

#[test]
fn forw_raw_direct_multi_dct_rs() {
    dharitri_sc_scenario::run_rs("scenarios/forw_raw_direct_multi_dct.scen.json", world());
}
...
fn forw_raw_sync_moax_rs() {
    dharitri_sc_scenario::run_rs("scenarios/forw_raw_sync_moax.scen.json", world());
}
...
fn forw_raw_sync_same_context_moax_rs() {
    dharitri_sc_scenario::run_rs(
        "scenarios/forw_raw_sync_same_context_moax.scen.json",
        world(),
    );
}
...
fn forw_raw_transf_exec_accept_moax_rs() {
    dharitri_sc_scenario::run_rs(
        "scenarios/forw_raw_transf_exec_accept_moax.scen.json",
        world(),
    );
}
...
fn forw_raw_transf_exec_reject_moax_rs() {
    dharitri_sc_scenario::run_rs(
        "scenarios/forw_raw_transf_exec_reject_moax.scen.json",
        world(),
    );
}
...
fn forwarder_call_async_accept_moax_rs() {
    dharitri_sc_scenario::run_rs(
        "scenarios/forwarder_call_async_accept_moax.scen.json",
        world(),
    );
}
...
fn forwarder_call_async_accept_dct_rs() {
    dharitri_sc_scenario::run_rs(
        "scenarios/forwarder_call_async_accept_dct.scen.json",
        world(),
    );
}
...
fn forwarder_call_async_retrieve_moax_rs() {
    dharitri_sc_scenario::run_rs(
        "scenarios/forwarder_call_async_retrieve_moax.scen.json",
        world(),
    );
}
...
fn forwarder_call_async_retrieve_dct_rs() {
    dharitri_sc_scenario::run_rs(
        "scenarios/forwarder_call_async_retrieve_dct.scen.json",
        world(),
    );
}
...
fn forwarder_call_sync_accept_moax_rs() {
    dharitri_sc_scenario::run_rs(
        "scenarios/forwarder_call_sync_accept_moax.scen.json",
        world(),
    );
}
...
fn forwarder_call_sync_accept_dct_rs() {
    dharitri_sc_scenario::run_rs(
        "scenarios/forwarder_call_sync_accept_dct.scen.json",
        world(),
    );
}
...
fn forwarder_call_sync_accept_then_read_moax_rs() {
    dharitri_sc_scenario::run_rs(
        "scenarios/forwarder_call_sync_accept_then_read_moax.scen.json",
        world(),
    );
}
...
fn forwarder_call_sync_accept_then_read_dct_rs() {
    dharitri_sc_scenario::run_rs(
        "scenarios/forwarder_call_sync_accept_then_read_dct.scen.json",
        world(),
    );
}
...
fn forwarder_call_sync_retrieve_moax_rs() {
    dharitri_sc_scenario::run_rs(
        "scenarios/forwarder_call_sync_retrieve_moax.scen.json",
        world(),
    );
}
...
fn forwarder_call_sync_retrieve_dct_rs() {
    dharitri_sc_scenario::run_rs(
        "scenarios/forwarder_call_sync_retrieve_dct.scen.json",
        world(),
    );
}
...
fn forwarder_call_transf_exec_accept_moax_rs() {
    dharitri_sc_scenario::run_rs(
        "scenarios/forwarder_call_transf_exec_accept_moax.scen.json",
        world(),
    );
}
...
fn forwarder_call_transf_exec_accept_dct_rs() {
    dharitri_sc_scenario::run_rs(
        "scenarios/forwarder_call_transf_exec_accept_dct.scen.json",
        world(),
    );
}
...
fn forwarder_get_dct_local_roles_rs() {
    dharitri_sc_scenario::run_rs(
        "scenarios/forwarder_get_dct_local_roles.scen.json",
        world(),
    );
}
...
fn forwarder_get_dct_token_data_rs() {
    dharitri_sc_scenario::run_rs("scenarios/forwarder_get_dct_token_data.scen.json", world());
}
...
fn forwarder_send_dct_multi_transfer_rs() {
    dharitri_sc_scenario::run_rs(
        "scenarios/forwarder_send_dct_multi_transfer.scen.json",
        world(),
    );
}
...
fn forwarder_send_twice_moax_rs() {
    dharitri_sc_scenario::run_rs("scenarios/forwarder_send_twice_moax.scen.json", world());
}

#[ignore]
#[test]
fn forwarder_send_twice_dct_rs() {
    dharitri_sc_scenario::run_rs("scenarios/forwarder_send_twice_dct.scen.json", world());
}
...
fn forwarder_tranfer_dct_with_fees_rs() {
    dharitri_sc_scenario::run_rs(
        "scenarios/forwarder_tranfer_dct_with_fees.scen.json",
        world(),
    );
}
...
fn recursive_caller_moax_1_rs() {
    dharitri_sc_scenario::run_rs("scenarios/recursive_caller_moax_1.scen.json", world());
}

#[test]
fn recursive_caller_dct_1_rs() {
    dharitri_sc_scenario::run_rs("scenarios/recursive_caller_dct_1.scen.json", world());
}

#[test]
fn send_moax_rs() {
    dharitri_sc_scenario::run_rs("scenarios/send_moax.scen.json", world());
}

#[test]
fn send_dct_rs() {
    dharitri_sc_scenario::run_rs("scenarios/send_dct.scen.json", world());
}
